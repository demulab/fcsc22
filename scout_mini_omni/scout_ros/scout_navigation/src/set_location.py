...
from scout_navigation.srv import SetLocation, SetLocationResponse
...
class SetLocationServer():
    ...
    def saveLocation(self, file_name):
        try:
            param_path = roslib.packages.get_pkg_dir("scout_params")
            map_path = roslib.packages.get_pkg_dir("scout_navigation")
